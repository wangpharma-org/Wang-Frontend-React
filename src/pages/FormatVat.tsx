            ...
            <div className="footer">
              ...
              <div className="Note text-xs">
                ...
                <ul className="font-bold text-[8px]">
                  <li>
                    เรียนท่านลูกค้า อำเภอเมืองสงขลา สิงหนคร และสทิงพระ
                    ผู้มีอุปการะคุณทุกท่าน
                  </li>
                  <li>วังเภสัชได้ปรับปรุงบริการ</li>
                  <li>
                    ออเดอร์เวลา 15:01 - 09:00 น. จัดส่งถึงท่านก่อน 13:00 น.
                  </li>
                  <li>
                    ออเดอร์เวลา 09:01 - 15:00 น. จัดส่งถึงท่านก่อน 19:00 น.
                  </li>
